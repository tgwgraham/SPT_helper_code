function im_ch1 = nd2read1chan_MFM(filename)
% nd2read1chan_MFM
% 
% usage:
% im_ch1 = nd2read1chan_MFM(filename)
% 
% read in single-channel, single-plane nd2 image from MFM
%
% derived from this: https://www.mathworks.com/matlabcentral/fileexchange/71345-nd2read
% TG 20200807
...
% For some reason, I need an offset of 8 here to get everything into
% register. This may need to be changed depending on the version of the
% software that is saving the nd2 file. - TG
fseek(fid, finfo.file_structure(strncmp('ImageDataSeq', ...
  {finfo.file_structure(:).nameAttribute}, 12)).dataStartPos + 8, 'bof'); 
